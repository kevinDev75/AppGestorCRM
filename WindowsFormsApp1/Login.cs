...
{
    public partial class LoginForm : RJCodeUI_M1.RJForms.RJBaseForm
    {
        ...
        {//Aplicar las propiedades de apariencia de la configuración.
            ...
            this.BackColor = RJColors.LightBackground;//Establecer el color de fondo

            if (UITheme.Light == UITheme.Light)//si el tema es CLARO, establecer los botones de maximizar, minimizar y cerrar en negro.
            {
               this.btnClose.Image = WindowsFormsApp1.Properties.Resources.CloseDark;
                this.btnMaximize.Image = WindowsFormsApp1.Properties.Resources.MaximizeDark;
                this.btnMinimize.Image = WindowsFormsApp1.Properties.Resources.MinimizeDark;
            }
        ...
        {//Metodo para iniciar sesión
            ...
            //Login
            var user = new RJCodeUI_M1.Models.User().Login(txtUser.Text, txtPassword.Text);

            if (user != null)
            {
                var mainForm = new FormPrincipal(user);
                mainForm.Show();
                this.Hide();
